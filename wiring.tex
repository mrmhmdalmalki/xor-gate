...
\begin{tikzpicture}[line width=1.1pt, font=\sffamily]
  ...
  % ---------- board body (one full-size 830-point breadboard) ----------
  \fill[board,rounded corners=7pt] (0.1,-0.5) rectangle (44.7,11.5);
  ...
  % centre gap (ravine)
  \fill[black!5] (0.3,5.85) rectangle (44.5,6.15);
  ...
  \draw[vcc]    (0.3,11.15) -- (44.5,11.15);
  \draw[gnd!80] (0.3,10.6)  -- (44.5,10.6);
  \draw[gnd!80] (0.3,0.0)   -- (44.5,0.0);
  \node[vcc,font=\footnotesize\bfseries,anchor=west] at (44.8,11.15) {$+5\,$V rail};
  \node[gnd,font=\footnotesize\bfseries,anchor=west] at (44.8,10.6)  {GND rail};
  \node[gnd,font=\footnotesize\bfseries,anchor=west] at (44.8,0.0)   {GND rail};
  ...
  \node[onet,anchor=west,font=\bfseries] at (45.5,5.2) {Output $Y=A\oplus B$};
  \fill[onet] (45.4,5.2) circle (1.5pt);
  ...
  \begin{scope}[shift={(0.3,-2.1)}]
    ...
    \node[anchor=west,font=\footnotesize\itshape] at (-0.2,-0.65)
        {One standard full-size (830-point) breadboard. The two GND rails are \textbf{one node} --
         bridge them with a jumper at the board edge.};
  \end{scope}
